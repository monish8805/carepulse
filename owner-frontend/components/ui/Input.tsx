...
export default function Input({ error = false, className = "", ...props }: InputProps) {
  return (
    <input
      className={`block w-full rounded-lg border bg-cp-input px-3 py-2 text-sm text-cp-text placeholder:text-cp-text-subtle focus:border-cp-focus-border focus:ring focus:ring-cp-focus-ring focus:outline-none dark:focus:border-cp-focus-border-dark dark:focus:ring-cp-focus-ring-dark disabled:cursor-not-allowed disabled:bg-cp-workspace disabled:text-cp-text-subtle dark:bg-cp-input-dark dark:text-cp-text-dark dark:placeholder:text-cp-text-subtle-dark dark:disabled:bg-cp-workspace-dark ${
        error
